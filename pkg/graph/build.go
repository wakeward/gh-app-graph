...
func readYAML(path string, dest any) error {
	data, err := os.ReadFile(path) // #nosec G304 -- path is a caller-supplied data file under data/
	if err != nil {
		return err
	}
...
func WriteResolved(yamlPath, jsonPath string, resolved Resolved) error {
	...
	data = append(data, '\n')
	return fileio.Write(jsonPath, data)
}
...
func writeYAML(path string, v any) error {
	return fileio.WriteYAML(path, "# Generated by cmd/build - do not edit by hand\n", v)
}
